...
class PodioBatch extends PodioObject
{
    ...
    {
        return $this->member($this->podio->get("/batch/{$batch_id}"));
    }
    ...
    {
        return $this->listing($this->podio->get("/batch/{$ref_type}/{$ref_id}/{$plugin}/running/"));
    }
    ...
    {
        return $this->listing($this->podio->get("/batch/", $attributes));
    }
