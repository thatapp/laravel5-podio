...
class PodioApp extends PodioObject
{
    ...
    {
        return $this->member($this->podio->get("/app/{$app_id}", $attributes));
    }
    ...
    {
        return $this->listing($this->podio->get("/app/v2/", $attributes));
    }

    /**
     * @see https://developers.podio.com/doc/applications/get-top-apps-22476
     */
    public function get_top($attributes = array())
    {
        return $this->listing($this->podio->get("/app/top/", $attributes));
    }

    /**
     * @see https://developers.podio.com/doc/applications/get-top-apps-for-organization-1671395
     */
    public function get_top_for_org($org_id, $attributes = array())
    {
        return $this->listing($this->podio->get("/app/org/{$org_id}/top/", $attributes));
    }

    /**
     * @see https://developers.podio.com/doc/applications/get-app-on-space-by-url-label-477105
     */
    public function get_for_url($space_id, $url_label, $attributes = array())
    {
        return $this->member($this->podio->get("/app/space/{$space_id}/{$url_label}", $attributes));
    }
    ...
    {
        return $this->listing($this->podio->get("/app/space/{$space_id}/", $attributes));
    }
    ...
    {
        return $this->member($this->podio->post("/app/", $attributes));
    }
    ...
    {
        return $this->podio->put("/app/{$app_id}", $attributes);
    }
    ...
    {
        return $this->podio->delete("/app/{$app_id}");
    }
    ...
    {
        $body = $this->podio->post("/app/{$app_id}/install", $attributes)->json_body();
        return $body['app_id'];
    }
     ...
     */
    public function update_org($space_id, $attributes = array())
    {
        return $this->podio->put("/app/space/{$space_id}/order", $attributes);
    }
    ...
    {
        return $this->podio->post("/app/{$app_id}/activate");
    }
    ...
    {
        return $this->podio->post("/app/{$app_id}/deactivate");
    }

    /**
     * @see https://developers.podio.com/doc/applications/get-calculations-for-app-773005
     */
    public function calculations($app_id)
    {
        return $this->listing($this->podio->get("/app/{$app_id}/calculation/"));
    }

    /**
     * @see https://developers.podio.com/doc/applications/get-features-43648
     */
    public function features($attributes = array())
    {
        return $this->podio->get("/app/features/")->json_body();
    }

    /**
     * @see https://developers.podio.com/doc/applications/get-app-dependencies-39159
     */
    public function dependencies($app_id)
    {
        $result = $this->podio->get("/app/{$app_id}/dependencies/")->json_body();
        $result['apps'] = $this->listing($result['apps']);
        return $result;
    }
     ...
     */
    public function dependencies_space($space_id)
    {
        $result = $this->podio->get("/space/{$space_id}/dependencies/")->json_body();
        $result['apps'] = $this->listing($result['apps']);
        return $result;
    }
     ...
     */
    public function activate_for_space($app_id, $space_id, $attributes = array())
    {
        return $this->podio->put("/app/{$app_id}/activate/{$space_id}", $attributes);
    }
