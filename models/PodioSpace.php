...
class PodioSpace extends PodioObject
{
    ...
    {
        return $this->member($this->podio->get("/space/{$space_id}"));
    }
    ...
    {
        return $this->listing($this->podio->get("/org/{$org_id}/space/"));
    }
    ...
    {
        return $this->member($this->podio->get("/space/url", $attributes));
    }

    /**
     * @see https://developers.podio.com/doc/spaces/get-available-spaces-1911961
     */
    public function get_available($org_id)
    {
        return $this->listing($this->podio->get("/space/org/{$org_id}/available/"));
    }
    ...
    {
        return $this->listing($this->podio->get("/space/top/", $attributes));
    }
    ...
    {
        return $this->podio->post("/space/", $attributes)->json_body();
    }
    ...
    {
        return $this->podio->put("/space/{$space_id}", $attributes);
    }

    /**
     * @see https://developers.podio.com/doc/spaces/delete-space-22417
     */
    public function delete($space_id, $attributes = array())
    {
        return $this->podio->delete("/space/{$space_id}");
    }
}
