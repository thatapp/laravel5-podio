...
class PodioReference extends PodioObject
{
    ...
    {
        return $this->member($this->podio->get("/reference/{$ref_type}/{$ref_id}", $attributes));
    }
    ...
    {
        return $this->podio->post("/reference/search", $attributes)->json_body();
    }

    /**
     * @see https://developers.podio.com/doc/reference/resolve-url-66839423
     */
    public function resolve($attributes = array())
    {
        return $this->member($this->podio->get("/reference/resolve", $attributes));
    }
