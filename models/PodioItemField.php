...
{
    public function __construct($podio, $attributes = array(), $force_type = null)
    {
     ...
     */
    public function update($item_id, $field_id, $attributes = array(), $options = array())
    {
        $url = $this->podio->url_with_options("/item/{$item_id}/value/{$field_id}", $options);
     ...
     */
    public function ical($item_id, $field_id)
    {
        return $this->podio->get("/calendar/item/{$item_id}/field/{$field_id}/ics/")->body;
    }

    /**
     * @see https://developers.podio.com/doc/calendar/get-item-field-calendar-as-ical-10195681
     */
    public function ical_field($item_id, $field_id)
    {
        return $this->podio->get("/calendar/item/{$item_id}/field/{$field_id}/ics/")->body;
    }
