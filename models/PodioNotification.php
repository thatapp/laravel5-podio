...
class PodioNotification extends PodioObject
{
    ...
    {
        $body = $this->podio->get("/notification/inbox/new/count")->json_body();
        return $body['new'];
    }
    ...
    {
        return $this->podio->post("/notification/viewed");
    }

    /**
     * @see https://developers.podio.com/doc/notifications/mark-notification-as-viewed-22436
     */
    public function mark_as_viewed($notification_id)
    {
        return $this->podio->post("/notification/{$notification_id}/viewed");
    }

    /**
     * @see https://developers.podio.com/doc/notifications/mark-notifications-as-viewed-by-ref-553653
     */
    public function mark_as_viewed_for_ref($ref_type, $ref_id)
    {
        return $this->podio->post("/notification/{$ref_type}/{$ref_id}/viewed");
    }
    ...
    {
        return $this->podio->post("/notification/{$notification_id}/star");
    }
    ...
    {
        return $this->podio->delete("/notification/{$notification_id}/star");
    }
