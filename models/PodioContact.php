...
class PodioContact extends PodioObject
{
    ...
    {
        $body = $this->podio->post("/contact/space/{$space_id}/", $attributes)->json_body();
    ...
    {
        return $this->podio->delete("/contact/{$profile_ids}");
    }

    /**
     * @see https://developers.podio.com/doc/contacts/get-user-contact-field-22403
     */
    public function get_field_for_user($user_id, $key)
    {
        return $this->podio->get("/contact/user/{$user_id}/{$key}")->json_body();
    }
    ...
    {
        return $this->podio->get("/contact/totals/")->json_body();
    }

    /**
     * @see https://developers.podio.com/doc/contacts/get-contact-totals-v3-34629208
     */
    public function get_totals_v3()
    {
        return $this->podio->get("/contact/totals/v3/")->json_body();
    }

    /**
     * @see https://developers.podio.com/doc/contacts/get-space-contact-totals-67508
     */
    public function get_totals_for_space($space_id)
    {
        return $this->podio->get("/contact/space/{$space_id}/totals/")->json_body();
    }

    /**
     * @see https://developers.podio.com/doc/contacts/get-contact-s-22335
     */
    public function get($profile_ids, $attributes = array())
    {
        $result = $this->podio->get("/contact/{$profile_ids}/v2", $attributes);
        if (is_array($result->json_body())) {
            return $this->listing($result);
        }
        return $this->member($result);
    }
    ...
    {
        return $this->podio->get("/contact/{$profile_id}/vcard")->body;
    }
    ...
    {
        return $this->member($this->podio->get("/contact/user/{$user_id}"));
    }
    ...
    {
        return $this->listing($this->podio->get("/contact/", $attributes));
    }
    ...
    {
        return $this->listing($this->podio->get("/contact/org/{$org_id}", $attributes));
    }
    ...
    {
        return $this->listing($this->podio->get("/contact/space/{$space_id}/", $attributes));
    }
    ...
    {
        return $this->listing($this->podio->get("/contact/app/{$app_id}/", $attributes));
    }

    /**
     * @see https://developers.podio.com/doc/contacts/get-skills-1346872
     */
    public function get_skills($attributes = array())
    {
        return $this->podio->get("/contact/skill/", $attributes)->json_body();
    }
    ...
    {
        return $this->podio->put("/contact/{$profile_id}", $attributes);
    }

    /**
     * @see https://developers.podio.com/doc/contacts/update-contact-field-60558
     */
    public function update_field($profile_id, $key, $attributes = array())
    {
        return $this->podio->put("/contact/{$profile_id}/{$key}", $attributes);
    }
